...
import datos.AlmacenamientoBeneficiosEstudiante;
 ...
 * @author Rayel
 */
public class DlgGestionAsignarBeneficios extends javax.swing.JDialog {

    protected AlmacenamientoBeneficiosEstudiante listaBeneficiosEstudiante;
    private DefaultTableModel tblModel;

    /**
     * Creates new form DlgGestionAutos
     */
    public DlgGestionAsignarBeneficios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public DlgGestionAsignarBeneficios(java.awt.Frame parent, boolean modal,
            AlmacenamientoBeneficiosEstudiante listaBeneficiosEstudiante) {
        super(parent, modal);
        initComponents();
        this.listaBeneficiosEstudiante = listaBeneficiosEstudiante;
    }
    ...
    private void btnInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertarActionPerformed
        DlgNuevosBeneficios win = new DlgNuevosBeneficios(null, true,
                listaBeneficiosEstudiante);
        win.setTitle("Agregar Beneficios");
        win.setVisible(true);
        this.listaBeneficiosEstudiante = win.listaBeneficiosEstudiante;
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if (tblBeneficios.getSelectedRowCount() == 1) {
            ...
            if (resp == 0) {  //Sí quiere eliminar el auto
                BeneficioEstudiantes beneEstu = listaBeneficiosEstudiante.buscarPorIdBeneficio(idBeneficio);
                if (listaBeneficiosEstudiante.eliminarBeneficioEstudiante(beneEstu)) {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if (tblBeneficios.getSelectedRowCount() == 1) {
            int pos = tblBeneficios.getSelectedRow();
             int idBeneficio = Integer.parseInt(tblBeneficios.getValueAt(tblBeneficios.getSelectedRow(), 0).toString());
             BeneficioEstudiantes beneEstu = listaBeneficiosEstudiante.buscarPorIdBeneficio(idBeneficio);

            DlgNuevosBeneficios winEditar = new DlgNuevosBeneficios(null, true, listaBeneficiosEstudiante, beneEstu, pos);

            winEditar.setTitle("Editar Beneficio");
            winEditar.setLocationRelativeTo(null);
            winEditar.setVisible(true);

            this.listaBeneficiosEstudiante = winEditar.listaBeneficiosEstudiante;
        } else {
            JOptionPane.showMessageDialog(this, "Debe seleccionar 1 Beneficio");
        }
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        ...
        String titulo[] = {"Id", "Nombre del Beneficio", "Costo"};

        BeneficioEstudiantes beneEstu;

        tblModel = new DefaultTableModel(null, titulo);
        for (int i = 0; i < listaBeneficiosEstudiante.getlistaBenefEstudiante().size(); i++) {
            beneEstu = listaBeneficiosEstudiante.getlistaBenefEstudiante().get(i);
            if (String.valueOf(beneEstu.getIdBeneficio()).contains(txtBuscar.getText())
                    || puesto.getNombrePuesto().toLowerCase().contains(txtBuscar.getText().toLowerCase())
                    || String.valueOf(puesto.getSalario()).contains(txtBuscar.getText())) {
                Object row[] = {listaPuestos.getListaPuestos().get(i).getIdPuestos(),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgGestionAsignarBeneficios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgGestionAsignarBeneficios dialog = new DlgGestionAsignarBeneficios(new javax.swing.JFrame(), true);

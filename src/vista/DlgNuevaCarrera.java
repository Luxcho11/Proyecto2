...
public class DlgNuevaCarrera extends javax.swing.JDialog {
    ...
    public DlgNuevaCarrera(java.awt.Frame parent, boolean modal,
            AlmacenamientoCarreras listaCarreras, Carreras carrera, int pos) {
        super(parent, modal);
        initComponents();
        this.listaCarreras = listaCarreras;
    ...
    private void initComponents() {
        ...
        lblMarca.setText("Nombre Carrera:");

        txtNomCarrera.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (txtId.getText().isBlank()
                || txtNomCarrera.getText().isBlank()
                || txtGrado.getText().isBlank()) {
            ...
            try {
                ...
                carrera.setNomCarrera(txtNomCarrera.getText());
                carrera.setGrado(txtGrado.getText());
                 switch (this.getTitle()) {
                    case "Agregar Carrera" -> {
                        if(listaCarreras.buscarIdCarreras(carrera.getIdCarrera()) == null) {
                            listaCarreras.insertarCarrera(carrera);
                            ...
                            JOptionPane.showMessageDialog(this, "El id de la carrera" 
                                    + "ya existe");
                    ...
                    case "Editar Carrera" -> {
                        ...
                        JOptionPane.showMessageDialog(this, "Carrera editada con éxito");
                        this.dispose();
                    }
                }
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        if (this.getTitle().equals("Editar Beneficio")){
            txtId.setText(String.valueOf(carrera.getIdCarrera()));
            txtId.setEnabled(false);
            txtNomCarrera.setText(carrera.getNomCarrera());
            txtGrado.setText(String.valueOf(carrera.getGrado()));
        }
